class Back extends Phaser.Scene {
    ...
    create() {
        ...
        // text
        this.add.bitmapText(game.config.width/1.4, 340, 'momstype', "Insert Name\n123 NotSharingThat\n######\nZX\nFAKECOUNTRY").setOrigin(0.5).setLeftAlign().setFontSize(28).setLineSpacing(35)
        this.add.bitmapText(game.config.width/5, game.config.height/6, 'momstype', "32/13/2077\nFAKECITY, ZX").setOrigin(0.5).setLeftAlign().setFontSize(30)
